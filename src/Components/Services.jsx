    ...
    >
      ...
      <div className="relative z-10 my-20 px-4 grid lg:grid-cols-3 lg:gap-8">
        ...
        <article className="lg:col-span-1">
          ...
          <h1 className="text-4xl font-bold my-2 tracking-wider">What I do?</h1>
